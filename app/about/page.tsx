          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div className="w-full mx-auto md:mx-0 p-7 md:p-6 bg-white/5 rounded-xl border border-white/10">
                  <div className="text-3xl sm:text-3xl font-bold text-white mb-2">
                    Comprehensive
                  </div>
                  <div className="text-base text-gray-300">Product Range</div>
                </div>
                <div className="w-full mx-auto md:mx-0 p-7 md:p-6 bg-white/5 rounded-xl border border-white/10">
                  <div className="text-3xl sm:text-3xl font-bold text-white mb-2">
                    Best
                  </div>
                  <div className="text-base text-gray-300">Quality</div>
                </div>
                <div className="w-full mx-auto md:mx-0 p-7 md:p-6 bg-white/5 rounded-xl border border-white/10">
                  <div className="text-3xl sm:text-3xl font-bold text-white mb-2">
                    Competitive
                  </div>
                  <div className="text-base text-gray-300">Prices</div>
                </div>
              </div>
            </div>
          </div>
