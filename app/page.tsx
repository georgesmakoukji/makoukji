...
export default function Home() {
  return (
    <article className="min-h-screen bg-white">
      ...
      <section className="py-14 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 safe-x-pad">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200"
              >
                <div className="w-14 h-14 md:w-16 md:h-16 bg-[#fae633] rounded-lg flex items-center justify-center mb-5 md:mb-6 text-white">
                  {feature.icon}
                </div>
      ...
      {/* Insurance Partners */}
      <section className="py-10 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 safe-x-pad">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <div
                key={index}
                className="glass-effect bg-white/80 rounded-2xl border border-white/60 shadow-lg p-5 md:p-6 text-center"
              >
                <div className="hidden md:flex mx-auto mb-3 h-10 w-10 rounded-full bg-[#fae633] items-center justify-center text-sm font-bold text-black">
                  {index + 1}
                </div>
                <h3 className="text-base md:text-xl font-semibold mb-1 md:mb-2 text-gray-900 uppercase tracking-wide">
                  {item.title}
                </h3>
